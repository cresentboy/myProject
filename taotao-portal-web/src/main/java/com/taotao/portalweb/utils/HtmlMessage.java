package com.taotao.portalweb.utils;
...
public class HtmlMessage {
	public static MimeMessage generate(String to) throws Exception
	{
		String from = "1547428520@qq.com "; // 发件人地址
		//String to = ""; // 收件人地址

		String subject = "HTML邮件";
		String body = "<a href=http://localhost:8081/activateSuccess.html?email="+to+">"
		  + "<h4>点击此链接以验证你的账户</h4></a></br>"
