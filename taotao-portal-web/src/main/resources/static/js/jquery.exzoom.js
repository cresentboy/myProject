;(function ($, window) {
    ...
    function init() {
        ...
        for (let i = 0; i < imgNum; i++) {
            ...
            imgArr[i][8] = 800;
            imgArr[i][9] = 800;
            exzoom_nav_inner.append("<span style='margin-left: 7px; width: 60px; height: 60px;'><img width='60' height='60' src='"+imgArr[i][0]+"'/></span>");
        ...
        //添加放大镜
        exzoom_img_box.append("<div class='exzoom_zoom_outer'><span class='exzoom_zoom'></span></div><p class='exzoom_preview'><img class='exzoom_preview_img' src='' />");
